...
#     " "
# )
default_alphabet = "alpha beta coda delta each fine gamma harp ice jester keep lambda maya nod over pi queer rho sigma tie ups vest whale ex why zeta".split(
    " "
)
