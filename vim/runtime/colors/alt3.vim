...
hi Type          ctermfg=127   ctermbg=None  cterm=None    guifg=#f5dd90 guibg=NONE    gui=NONE      
hi Statement     ctermfg=75    ctermbg=None  cterm=None    guifg=#ff785a guibg=NONE    gui=NONE      
hi Identifier    ctermfg=32    ctermbg=None  cterm=None    guifg=#324376 guibg=NONE    gui=NONE      
hi Keyword       ctermfg=75    ctermbg=None  cterm=None    guifg=#586ba4 guibg=NONE    gui=NONE      
